...
const BlogCard = ({ slug, title, excerpt, image, date }: BlogPost) => (
  <Card className="glossy-card group overflow-hidden border-transparent shine-effect">
    ...
    <div className="p-6">
      ...
      <p className="mb-4 text-sm text-muted-foreground line-clamp-2 leading-relaxed">{excerpt}</p>
